report 50004 "CBR Return Authorization"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ReturnAuthorizationCBR.rdl';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            {
                column(VATLineAmount; "VAT Amount")
                { }
            }
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(SalesLine; "Integer")
                    {
                        ...
                        column(TempSalesLine_UnitCost; TempSalesLine."Unit Cost")
                        {

                        }
                        column(ExtendedPrice; TempSalesLine.Quantity * TempSalesLine."Unit Price")
                        {

                        }
                        column(TempSalesLine_LineAmount; TempSalesLine."Line Amount")
                        {
                        ...
                        column(ExtendedPriceCaption; ExtendedPriceCaption)
                        {
    ...
    var
        ...
        ExtendedPriceCaption: Label 'Extended Price';
